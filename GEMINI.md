...
*   **Commit Messages**: All commit messages generated by Gemini must include a small one-liner annotation at the end (e.g., `> Assisted by Gemini 2.0 Flash`) to clearly indicate AI assistance and which specific model performed the work.
